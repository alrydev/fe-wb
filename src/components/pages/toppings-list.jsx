...
import DeleteData from "../modules/delete-data";
...
export default function ToppingsList() {
  ...
  const title = 'Toppings List';
  document.title = 'Waysbuck | ' + title;

  // Create variabel for id topping and confirm delete data with useState here ...
  ...
  const handleUpdate = (id) => {
    navigate('/update-topping/' + id);
  };

  // Create function handle get id topping & show modal confirm delete data here ...
  // For get id topping & show modal confirm delete data
  const handleDelete = (id) => {
    setIdDelete(id);
    handleShow();
  };

  // Create function for handle delete topping here ...
  ...
  return (
    <>
      ...
      <Container className="py-5">
        <Row>
          <Col xs="6">
            <div className="text-header-category mb-4">List of Topping</div>
          </Col>
